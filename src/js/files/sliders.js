...
function initSliders() {
	...
	if (document.querySelector('.events-poster__slider')) {
		// Створюємо слайдер
		new Swiper('.events-poster__slider', {
			modules: [Pagination],
			observer: true,
			observeParents: true,
			speed: 800,
	...
	if (document.querySelector('.poster__date-slider')) {
		// Створюємо слайдер
		new Swiper('.poster__date-slider', {
			modules: [],
			observer: true,
			observeParents: true,
			speed: 800,
